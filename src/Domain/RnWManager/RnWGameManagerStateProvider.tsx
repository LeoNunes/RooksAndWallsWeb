...
import type { RnWManagerDispatch } from "./Actions";
import { type RnWManagerState, rnwManagerInitialState } from "./Model";
...
export function useRnWManagerState(): RnWManagerState {
    ...
    if (rnwManagerState === undefined) {
        throw new Error("RnWManagerState is not available. Do you have a RnWManagerStateProvider providing it?");
    }
...
export function useRnWManagerDispatch(): RnWManagerDispatch {
    ...
    if (dispatch === undefined) {
        throw new Error("RnWManagerDispatch is not available. Do you have a RnWManagerStateProvider providing it?");
    }
    return dispatch;
}
...
export function RnWManagerStateProvider(props: RnWManagerStateProviderProps) {
    const [rnwManagerState, rnwManagerDispatch] = useAsyncReducer(rnwManagerReducer, rnwManagerInitialState);
